...
PHP_FUNCTION(call_user_func)
{
	...
	zend_parse_parameters_new(Z_PARAM_FCALL_INFO(fci, fci_cache) Z_PARAM_VARIADIC(fci.params, fci.param_count), {
		return;
	})
...
PHP_FUNCTION(call_user_func_array)
{
	...
	zend_parse_parameters_new(Z_PARAM_FCALL_INFO(fci, fci_cache) Z_PARAM_ARRAY_EX(params, Z_PARAM_BY_REF), {
		return;
	})
