...
static void php_html_entities(INTERNAL_FUNCTION_PARAMETERS, int all)
{
	...
	zend_parse_parameters_new(Z_PARAM_STRING(str, str_len) Z_OPTIONAL Z_PARAM_LONG(flags) Z_PARAM_STRING_CHECKNULL(hint_charset, hint_charset_len) Z_PARAM_BOOL(double_encode), {
		return;
	})
...
PHP_FUNCTION(html_entity_decode)
{
	...
	zend_parse_parameters_new(Z_PARAM_STRING(str, str_len) Z_OPTIONAL Z_PARAM_LONG(quote_style) Z_PARAM_STRING(hint_charset, hint_charset_len), {
		return;
	})
