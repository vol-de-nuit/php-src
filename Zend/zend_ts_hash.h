...
#define zend_ts_hash_update(ht, key, pData) \
		_zend_ts_hash_add_or_update(ht, key, pData, HASH_UPDATE | HASH_CHECK_COLLISION_ERROR ZEND_FILE_LINE_CC)
#define zend_ts_hash_add(ht, key, pData) \
		_zend_ts_hash_add_or_update(ht, key, pData, HASH_ADD | HASH_CHECK_COLLISION_ERROR ZEND_FILE_LINE_CC)
...
#define zend_ts_hash_index_update(ht, h, pData) \
		_zend_ts_hash_index_add_or_update(ht, h, pData, HASH_UPDATE | HASH_CHECK_COLLISION_ERROR  ZEND_FILE_LINE_CC)
#define zend_ts_hash_next_index_insert(ht, pData) \
		_zend_ts_hash_index_add_or_update(ht, ht->nNextFreeElement, pData, HASH_ADD | HASH_CHECK_COLLISION_ERROR ZEND_FILE_LINE_CC)
